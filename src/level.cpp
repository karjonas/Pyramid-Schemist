...
{
    return {{{{BLOCK, BLOCK, LADDER, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               BLOCK, LADDER, BLOCK, BLOCK}},
             {{EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               BLOCK, BLOCK, BLOCK, EMPTY}},
             {{EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, LADDER, BLOCK, BLOCK,
               BLOCK, BLOCK, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, LADDER, BLOCK, BLOCK,
...
{
    return {{{{BLOCK, BLOCK, LADDER, BLOCK, BLOCK, SNAKE, BLOCK, SNAKE, BLOCK,
               BLOCK, LADDER, BLOCK, BLOCK}},
             {{EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               BLOCK, BLOCK, BLOCK, EMPTY}},
             ...
             {{EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               BLOCK, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, LADDER, BLOCK, BLOCK,
               EMPTY, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, EMPTY,
               EMPTY, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, BLOCK, EMPTY, EMPTY,
...
{
    return {{{{BLOCK, BLOCK, LADDER, BLOCK, SNAKE, BLOCK, BLOCK, BLOCK, SNAKE,
               BLOCK, LADDER, BLOCK, BLOCK}},
             {{EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, LADDER, BLOCK, LADDER, BLOCK,
               BLOCK, BLOCK, BLOCK, EMPTY}},
             {{EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               BLOCK, BLOCK, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, LADDER, BLOCK, LADDER, BLOCK,
               BLOCK, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, BLOCK, BLOCK, BLOCK, BLOCK, BLOCK,
               EMPTY, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, BLOCK, LADDER, BLOCK, EMPTY,
               EMPTY, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, LADDER, EMPTY, EMPTY,
               EMPTY, EMPTY, EMPTY, EMPTY}},
             {{EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
               EMPTY, EMPTY, EMPTY, EMPTY}}}};
}
